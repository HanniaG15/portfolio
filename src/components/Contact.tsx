...
const info = [
  { icon: Mail,         label: "Email",     value: "famyuwury@gmail.com",  href: "mailto:famyuwury@gmail.com", color: "#00f5ff" },
  { icon: GithubIcon,   label: "GitHub",    value: "github.com/HanniaG15",     href: "https://github.com/HanniaG15",  color: "#7b2fff" },
